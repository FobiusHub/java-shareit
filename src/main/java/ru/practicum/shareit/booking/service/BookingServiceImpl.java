...
public class BookingServiceImpl implements BookingService {
    ...
    private void checkBookingDates(BookingDto bookingDto) {
        ...
        if (start.equals(end)) {
            log.warn("Даты начала и конца бронирования должны различаться");
            throw new InvalidBookingDatesException("Даты начала и конца бронирования должны различаться");
        }

        if (start.isAfter(end)) {
            log.warn("Дата начала бронирования не может быть после даты конца бронирования");
            throw new InvalidBookingDatesException("Дата начала бронирования не может быть после даты конца бронирования");
        }
    }
}
